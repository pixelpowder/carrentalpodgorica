...
export default function BorderCrossing() {
  ...
  return (
    <ContentPage title={t("border-crossing.title")} subtitle={t("border-crossing.subtitle")} description={t("border-crossing.seoDesc")} image="/img/belgrade-cityscape.webp">
      ...
      <ul>
        <li>{t('borderCrossingBody.greenCard1')}</li>
        <li>{t('borderCrossingBody.greenCard2')}</li>
        <li>{t('borderCrossingBody.greenCard3')}</li>
      </ul>
      <p>{t('borderCrossingBody.greenCardWarn')}</p>

      <h2>{t('borderCrossingBody.docsTitle')}</h2>
      <ul>
        <li>{t('borderCrossingBody.doc1')}</li>
        <li>{t('borderCrossingBody.doc2')}</li>
        <li>{t('borderCrossingBody.doc3')}</li>
        <li>{t('borderCrossingBody.doc4')}</li>
        <li>{t('borderCrossingBody.doc5')}</li>
      </ul>
      ...
      <ul>
        <li>{t('borderCrossingBody.tip1')}</li>
        <li>{t('borderCrossingBody.tip2')}</li>
        <li>{t('borderCrossingBody.tip3')}</li>
        <li>{t('borderCrossingBody.tip4')}</li>
        <li>{t('borderCrossingBody.tip5')}</li>
        <li>{t('borderCrossingBody.tip6')}</li>
      </ul>

      <h2>{t('borderCrossingBody.lawsTitle')}</h2>
      <p>{t('borderCrossingBody.lawsIntro')}</p>
      <ul>
        <li>{t('borderCrossingBody.law1')}</li>
        <li>{t('borderCrossingBody.law2')}</li>
        <li>{t('borderCrossingBody.law3')}</li>
        <li>{t('borderCrossingBody.law4')}</li>
        <li>{t('borderCrossingBody.law5')}</li>
      </ul>

      <h2>{t('borderCrossingBody.popularTitle')}</h2>
      <ul>
        <li>{t('borderCrossingBody.route1')}</li>
        <li>{t('borderCrossingBody.route2')}</li>
        <li>{t('borderCrossingBody.route3')}</li>
        <li>{t('borderCrossingBody.route4')}</li>
      </ul>
