...
const LOCATIONS = [
  'Podgorica', 'Podgorica Airport', 'Tuzi', 'Danilovgrad', 'Nikšić',
  'Virpazar', 'Rijeka Crnojevića', 'Cetinje', 'Kolašin', 'Bar',
];
...
const HOMEPAGE_FLEET_SLUGS = ['vw-polo', 'skoda-octavia', 'toyota-corolla', 'mercedes-c-class', 'jeep-renegade', 'bmw-x3', 'fiat-500'];
    ...
    <section className="section fleet-showcase" id="fleet-info">
      <div className="container">
        <div className="section-header">
          ...
          <h2 className="section-title">{tf('fleetShowcase.title', 'Guides to every car in our Podgorica fleet')}</h2>
...
const ROUTE_IMAGES = [
  { image: '/img/blog-niksic-beer-lake-loop.webp', href: '/blog/niksic-beer-lake-loop' },
  { image: '/img/blog-podgorica-rijeka-crnojevica-drive.webp', href: '/blog/podgorica-rijeka-crnojevica-drive' },
  { image: '/img/blog-komovi-mountains-berane-road.webp', href: '/blog/komovi-mountains-berane-road' },
  { image: '/img/blog-tuzi-albanian-border-short-hop.webp', href: '/blog/tuzi-albanian-border-short-hop' },
];
...
const TIP_IMAGES = ['/img/blog-gorica-hill-walk.webp', '/img/blog-stara-varos-podgorica-ottoman-quarter.webp', '/img/blog-podgorica-morning-coffee-spots.webp'];
...
const EXPERIENCE_SLOTS = [
  { image: '/img/blog-stara-varos-podgorica-ottoman-quarter.webp', href: '/blog/stara-varos-podgorica-ottoman-quarter' },
  { image: '/img/blog-podgorica-millennium-bridge-new-city.webp', href: '/blog/podgorica-millennium-bridge-new-city' },
  { image: '/img/blog-podgorica-morning-coffee-spots.webp', href: '/blog/podgorica-morning-coffee-spots' },
  { image: '/img/blog-komovi-mountains-berane-road.webp', href: '/blog/komovi-mountains-berane-road' },
];
        ...
        <div className="affiliate-promo__inner">
          <div className="affiliate-promo__text">
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              ...
              <a href={localePath('/blog/niksic-beer-lake-loop')} className="aff-outline-btn">{t('roadTripPlanner.lovcenGuide')}</a>
            </div>
          </div>
...
function DriveTimesMap() {
  const { t, localePath } = useTranslation();
  const hrefs = ['/blog/podgorica-wineries-plantaze', '/blog/gorica-hill-walk', '/blog/niksic-beer-lake-loop', '/blog/podgorica-rijeka-crnojevica-drive', '/blog/tuzi-albanian-border-short-hop'];
  return (
