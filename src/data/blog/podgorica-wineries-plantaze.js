// Auto-extracted blog body content for podgorica-wineries-plantaze.
export const post = {
  ...
  bodyHtml: `<h2>The vineyard you fly over on landing</h2>
      ...
      <p>The cellar is signed from the main E80 / E762 road between Podgorica and the airport. Drive time from the centre of Podgorica is around 15 to 20 minutes. From Podgorica Airport itself, under 10 minutes. There is a large free car park at the cellar gate.</p>
      ...
      <h2>Pair with</h2>
      <p>A Crmnica afternoon pairs naturally with the drive to <a href="{{LP:/blog/podgorica-rijeka-crnojevica-drive}}">Rijeka Crnojevića and the Pavlova Strana viewpoint</a>, both sit above Lake Skadar on the same side. For a more urban day, combine Šipčanik with <a href="{{LP:/blog/podgorica-millennium-bridge-new-city}}">the Millennium Bridge and the new city</a>.</p>

      <div class="route-info">
        <h3>At a glance</h3>
        <div class="route-info__grid">
          <div class="route-info__item"><strong>Vineyard size</strong>~2,310 ha (single block)</div>
          <div class="route-info__item"><strong>Šipčanik tunnel</strong>Former military hangar, 150 m deep</div>
          <div class="route-info__item"><strong>Tour length</strong>~90 minutes</div>
          <div class="route-info__item"><strong>Crmnica drive</strong>35 to 45 km south</div>
        </div>
      </div>`
};
