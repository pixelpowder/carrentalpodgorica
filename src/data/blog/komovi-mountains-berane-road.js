// Auto-extracted blog body content for komovi-mountains-berane-road.
export const post = {
  ...
  bodyHtml: `<h2>The two Koms</h2>
      ...
      <p>Total drive time from Podgorica to the Štavna katuns is in the region of 2.5 to 3 hours via Kolašin/Andrijevica.</p>
      ...
      <p>This is a long day. Plan for around 250 to 300 km of driving round-trip from Podgorica depending on whether you continue to Berane. Fuel in Podgorica and again in Kolašin, stations become sparse in the mountains.</p>

      <h2>Pair with</h2>
      <p>If the Komovi have lit a fire for mountain driving, pair this with the <a href="{{LP:/blog/niksic-beer-lake-loop}}">Nikšić and Ostrog loop</a> on another day for the opposite side of Montenegro's spine. For a calmer day back near the capital, see <a href="{{LP:/blog/podgorica-rijeka-crnojevica-drive}}">Pavlova Strana and Rijeka Crnojevića</a>.</p>

      <div class="route-info">
        <h3>At a glance</h3>
        <div class="route-info__grid">
          <div class="route-info__item"><strong>Kom Kučki</strong>2,487 m</div>
          <div class="route-info__item"><strong>Kom Vasojevićki</strong>2,461 m</div>
          <div class="route-info__item"><strong>Katun altitude</strong>~1,700 m (Štavna)</div>
          <div class="route-info__item"><strong>Drive from Podgorica</strong>~2.5 to 3 h</div>
        </div>
      </div>`
};
