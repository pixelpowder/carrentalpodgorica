// Auto-extracted blog body content for stara-varos-podgorica-ottoman-quarter.
export const post = {
  ...
  bodyHtml: `<h2>The oldest part of a young-looking city</h2>
      ...
      <h2>Pair with</h2>
      <p>A walk in Stara Varoš sits naturally with a loop across the river to the modern city, the <a href="{{LP:/blog/podgorica-millennium-bridge-new-city}}">Millennium Bridge and the new cathedral</a> are 15 minutes on foot. If you have the morning free, follow up with <a href="{{LP:/blog/gorica-hill-walk}}">Gorica Hill</a> for a view back down over the old quarter.</p>

      <div class="route-info">
        <h3>At a glance</h3>
        <div class="route-info__grid">
          <div class="route-info__item"><strong>Clock tower</strong>17th-century, 19 m</div>
          <div class="route-info__item"><strong>Ottoman period</strong>1474 to 1879</div>
          <div class="route-info__item"><strong>Walk time</strong>40 to 60 minutes</div>
          <div class="route-info__item"><strong>Best light</strong>Early morning or late afternoon</div>
        </div>
      </div>`
};
