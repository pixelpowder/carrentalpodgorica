// Auto-extracted blog body content for podgorica-rijeka-crnojevica-drive.
export const post = {
  ...
  bodyHtml: `<h2>The photograph you've already seen</h2>
      ...
      <p>Total drive from Podgorica: around 45 to 50 km to the viewpoint. Allow 1 hour 15 minutes with a slow descent.</p>
      ...
      <h2>Pair with</h2>
      <p>Rijeka Crnojevića pairs naturally with Cetinje (the old royal capital, covered on the sibling Podgorica site) or with a continuation south to <a href="{{LP:/blog/podgorica-wineries-plantaze}}">Crmnica wine country</a>. For an urban contrast the next day, walk <a href="{{LP:/blog/stara-varos-podgorica-ottoman-quarter}}">Stara Varoš</a>.</p>

      <div class="route-info">
        <h3>At a glance</h3>
        <div class="route-info__grid">
          <div class="route-info__item"><strong>Distance</strong>~45 to 50 km from Podgorica</div>
          <div class="route-info__item"><strong>Drive time</strong>~1 h 15 min</div>
          <div class="route-info__item"><strong>Viewpoint parking</strong>~8 spaces, free</div>
          <div class="route-info__item"><strong>Best light</strong>Mid-morning or late afternoon</div>
        </div>
      </div>`
};
