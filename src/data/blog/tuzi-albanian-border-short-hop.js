// Auto-extracted blog body content for tuzi-albanian-border-short-hop.
export const post = {
  ...
  bodyHtml: `<h2>The town that only became a town in 2018</h2>
      ...
      <h2>Pair with</h2>
      <p>Tuzi pairs well with <a href="{{LP:/blog/podgorica-wineries-plantaze}}">a Plantaže Šipčanik tour</a> on the same day, both are south of the centre. For the mountain scenery Tuzi only hints at, plan a separate day for the <a href="{{LP:/blog/komovi-mountains-berane-road}}">Komovi mountains road east</a>.</p>

      <div class="route-info">
        <h3>At a glance</h3>
        <div class="route-info__grid">
          <div class="route-info__item"><strong>Distance</strong>~15 km from Podgorica</div>
          <div class="route-info__item"><strong>Drive time</strong>~20 min</div>
          <div class="route-info__item"><strong>Border to Shkodër</strong>~30 min further</div>
          <div class="route-info__item"><strong>Cross-border</strong>Green Card required</div>
        </div>
      </div>`
};
