// Auto-extracted blog body content for niksic-beer-lake-loop.
export const post = {
  ...
  bodyHtml: `<h2>The shape of the day</h2>
      <p>This is an easy loop from the capital, about 160 km in total with no mountain passes above 700 m. Allow 8 to 10 hours if you want time to swim and to queue (briefly) for Ostrog in high season. The route: Podgorica to Nikšić (~55 km, 1 hour) to Krupac Lake (15 minutes from Nikšić) to Ostrog Monastery (~35 km from the lake) to Podgorica (~50 km).</p>
      ...
      <p>Allow 60 to 90 minutes at Ostrog. Come late afternoon: by 16:00 the tour coaches have usually left and the light on the cliffs turns gold.</p>
      ...
      <h2>Pair with</h2>
      <p>If you have a second day, head east from Nikšić into the wilder country, see the <a href="{{LP:/blog/komovi-mountains-berane-road}}">Komovi Mountains day</a>. For a more city-centred trip, the <a href="{{LP:/blog/podgorica-wineries-plantaze}}">Plantaže wineries</a> are closer and quicker.</p>

      <div class="route-info">
        <h3>At a glance</h3>
        <div class="route-info__grid">
          <div class="route-info__item"><strong>Total loop</strong>~160 km</div>
          <div class="route-info__item"><strong>Time needed</strong>8 to 10 hours</div>
          <div class="route-info__item"><strong>Krupac altitude</strong>~620 m</div>
          <div class="route-info__item"><strong>Ostrog road</strong>Narrow, slow, manageable</div>
        </div>
      </div>`
};
