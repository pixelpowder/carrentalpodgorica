// Auto-extracted blog body content for podgorica-morning-coffee-spots.
// Lives under src/data/blog/<slug>.js so it is whitelisted by audit-hardcoded-jsx
// (per-post per-locale data files are excluded from the JSX-text scan).
export const post = {
  ...
  bodyHtml: `<h2>Why mornings matter in Podgorica</h2>
      ...
      <p>Prices are low by European standards, a plain espresso is typically €1.20 to €1.80, even on the pedestrian café streets.</p>
      ...
      <p>Other morning bakery staples: <strong>pita</strong> (a broader term for the same pastry family), <strong>krofne</strong> (fried doughnuts), <strong>kifla</strong> (a small horseshoe bread roll). Burek is typically €1.50 to €2.50 a piece.</p>
      ...
      <ul>
        <li><strong>Red / yellow / blue zones</strong> are paid Monday to Saturday roughly 07:00 to 21:00. Sunday is usually free in most zones, check the sign.</li>
        <li>Pay at a meter or by SMS from a local or roaming-enabled phone. Instructions are on the meter.</li>
        <li>Fines are issued routinely. A clamped car is a long half-day, so pay the €0.50 to €1.00 per hour and move on.</li>
      </ul>
      ...
      <h2>Pair with</h2>
      <p>A leisurely morning pairs with a short-day walk, <a href="{{LP:/blog/stara-varos-podgorica-ottoman-quarter}}">Stara Varoš</a> is the obvious next step, or <a href="{{LP:/blog/gorica-hill-walk}}">Gorica Hill</a> before the sun gets too high. If you want to leave town, provision at the pijaca first and head for <a href="{{LP:/blog/podgorica-rijeka-crnojevica-drive}}">Rijeka Crnojevića</a>.</p>

      <div class="route-info">
        <h3>At a glance</h3>
        <div class="route-info__grid">
          <div class="route-info__item"><strong>Espresso price</strong>€1.20 to €1.80</div>
          <div class="route-info__item"><strong>Burek slice</strong>€1.50 to €2.50</div>
          <div class="route-info__item"><strong>Zone parking</strong>Paid Mon to Sat, free Sun</div>
          <div class="route-info__item"><strong>Leave the city</strong>Before 08:00 or after 09:30</div>
        </div>
      </div>`
};
