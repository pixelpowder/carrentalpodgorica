// Auto-extracted blog body content for podgorica-millennium-bridge-new-city.
export const post = {
  ...
  bodyHtml: `<h2>The modern capital in a single afternoon</h2>
      ...
      <h2>Pair with</h2>
      <p>The natural pairing is <a href="{{LP:/blog/stara-varos-podgorica-ottoman-quarter}}">Stara Varoš</a>, the historic Ottoman quarter is directly across the Ribnica from the new city, and the two together give you a complete picture of the capital. For a full day, follow up with <a href="{{LP:/blog/gorica-hill-walk}}">Gorica Hill</a> for a view down over both districts.</p>

      <div class="route-info">
        <h3>At a glance</h3>
        <div class="route-info__grid">
          <div class="route-info__item"><strong>Bridge completed</strong>2005</div>
          <div class="route-info__item"><strong>Main span</strong>140 m; pylon 57 m</div>
          <div class="route-info__item"><strong>Cathedral consecrated</strong>2013</div>
          <div class="route-info__item"><strong>Walk loop</strong>~4 km</div>
        </div>
      </div>`
};
